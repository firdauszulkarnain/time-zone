                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">FORM REGISTRASI <strong>CUSTOMER</strong></h1>
                            </div>
                            <form class="user" method="POST" action="">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="alamat" placeholder="Alamat" name="alamat" autocomplete="off" value="<?= set_value('alamat');  ?>">
                                    <?= form_error('alamatcustomer', '<small class="form-text text-danger pl-3">', '</small>'); ?>
                                </div>
